...
export default class Footer extends Component {
    render() {
        return (
            <footer className="text-gray-600 body-font bg-gray-50 border shadow">
                <div className="container px-5 py-2 mx-auto flex items-center sm:flex-row flex-col">
                    ...
                    <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2023 JKTV22
                        <a href="https://www.facebook.com/boriss.atonen" className="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">Boriss Atonen</a>
                    </p>
                    ...
                    <a className="ml-3 text-gray-500" href="https://twitter.com/" >
                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
